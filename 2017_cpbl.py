...
with open('win_lose_2017_re.json', 'r', encoding='utf-8') as file:
...
def main():
    ...
    n_games = 15#int(input("Input the number of games that each team plays against another in a half-season: "))
    ...
    for i in range(test_num):
        ...
        season_2017 = assign_schedule("schedule_2017_re.txt")
        first_half_season = season_2017[0:120]
        # gen_first_half_season_record(teams, n_games)
        assign_win_lose(teams, 120)
        ...
        if num_game_assigned_second > 0: 
            ...
            assign_win_lose(teams, 120+num_game_assigned_second)
        ...
        while best_loss != 0 and annealing_time < max_annealing_time:
            ...
            if annealing_time == 0:
                second_half_season = season_2017[120:240]
            else:
